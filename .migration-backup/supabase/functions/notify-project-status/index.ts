...
function buildStatusEmailHtml(
  ...
  return [
    ...
    '<a href="mailto:info@primehaven.tech" style="color:#fe4c18;text-decoration:none;">info@primehaven.tech</a></p>',
...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const trackingLink = `https://primehaven.tech/track/${project.tracking_token}`;
