...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Pricing', icon: Tag, path: '/superadmin', tab: 'pricing' },
      { label: 'Promos', icon: Ticket, path: '/superadmin', tab: 'promos' },
      { label: 'Clients', icon: UserSquare, path: '/superadmin', tab: 'clients' },
