    ...
    <section id="about" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-bold mt-4 mb-6 text-foreground">Our Impact in <span className="display-italic text-primary">Numbers</span></h2>
          ...
          {statItems.map((stat, index) => (
            ...
            >
              <motion.div
                ...
                className="paper-card p-8 text-center group hover:glow-primary transition-all cursor-pointer relative overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-4xl md:text-5xl font-heading font-bold display-italic text-primary mb-2">
